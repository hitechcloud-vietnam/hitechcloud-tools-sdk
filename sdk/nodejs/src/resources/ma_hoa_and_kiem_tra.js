...
class MaHoaAndKiemTraResource {
  ...
  tools_crypto_base64_decode(params) { return this._http.get('/api/tools/crypto/base64/decode', params); }

  /** GET /api/tools/crypto/base64/encode - Mã hoá chuỗi sang Base64 */
  tools_crypto_base64_encode(params) { return this._http.get('/api/tools/crypto/base64/encode', params); }

  /** GET /api/tools/crypto/bcrypt/hash - Băm mật khẩu bằng bcrypt */
  tools_crypto_bcrypt_hash(params) { return this._http.get('/api/tools/crypto/bcrypt/hash', params); }

  /** GET /api/tools/crypto/bcrypt/verify - Đối chiếu mật khẩu với một chuỗi băm bcrypt */
  tools_crypto_bcrypt_verify(params) { return this._http.get('/api/tools/crypto/bcrypt/verify', params); }

  /** GET /api/tools/crypto/hash - Băm chuỗi bằng md5 */
  tools_crypto_hash(params) { return this._http.get('/api/tools/crypto/hash', params); }

  /** GET /api/tools/crypto/html/decode - Đổi thực thể HTML về ký tự gốc */
  tools_crypto_html_decode(params) { return this._http.get('/api/tools/crypto/html/decode', params); }

  /** GET /api/tools/crypto/html/encode - Đổi ký tự đặc biệt sang thực thể HTML */
  tools_crypto_html_encode(params) { return this._http.get('/api/tools/crypto/html/encode', params); }

  /** GET /api/tools/crypto/jwt/decode - Giải mã JWT và hiển thị header */
  tools_crypto_jwt_decode(params) { return this._http.get('/api/tools/crypto/jwt/decode', params); }

  /** GET /api/tools/crypto/url/decode - Giải mã chuỗi đã mã hoá theo chuẩn URL */
  tools_crypto_url_decode(params) { return this._http.get('/api/tools/crypto/url/decode', params); }

  /** GET /api/tools/crypto/url/encode - Mã hoá chuỗi để đưa an toàn vào URL */
  tools_crypto_url_encode(params) { return this._http.get('/api/tools/crypto/url/encode', params); }

  /** GET /api/tools/crypto/uuid - Sinh mã UUID v4 */
  tools_crypto_uuid(params) { return this._http.get('/api/tools/crypto/uuid', params); }
  ...
  utility_crypto_jwt_verify(data) { return this._http.post('/api/utility/crypto/jwt/verify', data); }

  /** POST /api/utility/crypto/password - Sinh mật khẩu và tính ENTROPY THẬT của nó theo... */
  utility_crypto_password(data) { return this._http.post('/api/utility/crypto/password', data); }

  /** GET /api/utility/crypto/random - Byte ngẫu nhiên mật mã */
  utility_crypto_random(params) { return this._http.get('/api/utility/crypto/random', params); }

  /** GET /api/utility/crypto/uuid - Sinh UUID phiên bản 1 */
  utility_crypto_uuid(params) { return this._http.get('/api/utility/crypto/uuid', params); }

  /** GET /api/utility/crypto/uuid/2 - Bóc một UUID ra thành phần: phiên bản */
  utility_crypto_uuid_2(params) { return this._http.get('/api/utility/crypto/uuid/2', params); }

}

module.exports = { MaHoaAndKiemTraResource };
