...
class MaHoaAndKiemTraResource(private val httpClient: HttpClient) {
    ...
    fun toolsCryptoHtmlEncode(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
        return httpClient.get("/api/tools/crypto/html/encode", params)
    }

    /** GET /api/tools/crypto/jwt/decode - Giải mã JWT và hiển thị header */
    fun toolsCryptoJwtDecode(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun toolsCryptoUrlDecode(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityChecksumHash(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityChecksumIban(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityChecksumImo(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
        return httpClient.post("/api/utility/checksum/imo", params)
    }

    /** POST /api/utility/checksum/isbn - Kiểm ISBN-10 và ISBN-13 */
    fun utilityChecksumIsbn(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityChecksumIssn(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityChecksumLuhn(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityCryptoHmacVerify(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
        return httpClient.post("/api/utility/crypto/hmac/verify", params)
    }

    /** POST /api/utility/crypto/jwt/sign - Ký một JWT theo RFC 7519 */
    fun utilityCryptoJwtSign(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
    ...
    fun utilityCryptoJwtVerify(params: Map<String, Any?> = emptyMap()): Map<String, Any> {
